    ...
    <div class="container-fluid p-0">
        ...
        <div class="row g-0">
            ...
            <div class="col-lg-6 order-lg-1 my-auto showcase-text">
                ...
                <p class="lead mb-0">Siej sadz rośliny o owocach jadalnych oraz kwiatów. Jeśli posadzisz owoce w tym
                    czasie zbiory będą najbardziej obfite.
                    Jest to najlepszy czas do ścianania zrazów oraz szczepienia. W kwadrze owocu z powodzeniem siać
                    można także rośłiny liściowe, a nawet korzeniowe plonujące w danym roku.
                    Warto też w tym czasie wykonywać opryski na choroby grzybicze roślin</p>
            </div>
        </div>
        <div class="row g-0">
