...
<section class="showcase">
    <div class="container-fluid p-0">
        ...
        <div class="row g-0">
            ...
            <div class="col-lg-6 order-lg-2 text-white showcase-img" style="background-image: url('/img/Liliowiec-Open-My-Eyes-4694.jpg')"></div>
            <div class="col-lg-6 order-lg-1 my-auto showcase-text">

                <h2> Co możesz robić w tym czasie </h2>

                <p class="lead mb-0">To najlepszy czas by siać, sadzić rośliny plonujące pod ziemią, korzeniowe, cebulowe, wieloletnie byliny kwiatowe(np. liliowiec, rzodkiew, brukiew).
                W tym czasie zaczynamy zbiory roślin korzeniowych. Najlepiej wykonać teraz ukorzenianie zrazów,sadzonek zieonych kwiatów, krzewów, roślin doniczkowych.
                    Ścięta w tej kwadrze trawa wolniej odrasta</p>
            </div>
        </div>
        <div class="row g-0">
            <div class="col-lg-6 text-white showcase-img" style="background-image: url('/img/pruning+shears.jpg')"></div>
            <div class="col-lg-6 my-auto showcase-text">
                <h2>Czego unikać</h2>
                <p class="lead mb-0">Unikaj nawożenia oraz cięć drzew i krzewów</p>
            </div>
        </div>
    </div>
    <div class="row g-0">
