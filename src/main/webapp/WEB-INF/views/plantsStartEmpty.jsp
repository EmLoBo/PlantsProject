        ...
        <div class="row justify-content-center">
            <div class="col-xl-6">
                <div class="text-left text-white">
                    ...
                    <form>
                        ...
                        <p id="lon">Zaloguj się by podać parametry</p>
            ...
            <div class="col-xl-6">
                <div class="text-left text-white">
                    ...
                    <form>
                        <h3 id=" gardenerAlert"> Zaloguj się by widzieć ostrzeżenia pogodowe!</h3>
            ...
            <div class="col-xl-6">
                ...
                <form class="form-subscribe" id="contactFormFooter" data-sb-form-api-token="API_TOKEN">
                    ...
                    <div class="row">
                        ...
                        <div class="col-auto">
                            <button class="btn btn-primary btn-lg disabled" id="submitButton" type="submit">Dołączam!
                            </button>
                        </div>
                    </div>
