...
<section class="showcase">
    <div class="container-fluid p-0">
        ...
        <h2 class="mb-5 text-center"><a href="<c:url value="/plants/crop"/>">Poprzednia kwadra</a>    ~~~Kwadra Liścia ~~~   <a href="<c:url value="/plants/fruit"/>">Kolejna kwadra</a></h2>
        ...
        <div class="row g-0">
            ...
            <div class="col-lg-6 order-lg-1 my-auto showcase-text">
                ...
                <p class="lead mb-0">Najlepszy czas do siania i sadzenia roślin plonujących nad ziemią o mięsistych liściach (sałata, rukola, pietruszka itp).
                Jest to także dogodny czas do uprawy roślin o ozdobnych liściach.
                W tym czasie można również ciąć trawę, jeśli pragniemy ją wzmocnić.. Cięta w kwadrze korzenia i uprawy wolniej odrasta.</p>
            </div>
        </div>
        <div class="row g-0">
            ...
            <div class="col-lg-6 my-auto showcase-text">
                <h2>Czego unikać</h2>
                <p class="lead mb-0">Unikaj cięcia drzew i krzewów</p>
            </div>
        </div>
    </div>
    <div class="row g-0">
